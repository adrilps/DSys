...
public class EchoServerTCP_Thread_Server extends Thread {
   ...
   public void replyCreateMovie() {
   	
   }
   
   public void replyCreateReview() {
   	
   }
   
   public void replyCreateUser() {
   	
   }
   
   public void replyListMovies() {
   	
   }
   
   public void replySelectMovieById() {
   	
   }
   
   public void replyUpdateMovie() {
   	
   }
   
   public void replyUpdateReview() {
   	
   }
   
   public void replyUpdateUser() {
   	
   }
   
   public void replyDeleteMovie() {
   	
   }
   
   public void replyDeleteReview() {
